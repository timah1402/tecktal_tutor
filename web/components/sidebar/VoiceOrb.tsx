 ...
 *
 * The actual live call (the WebRTC connection + voice-triggered actions)
 * lives in ``VoiceCallContext``, shared with the home page's big hero voice
 * button (``HeroQuickActions``) so tapping either one drives the *same*
 * call instead of opening a second, independent connection.
 *
 ...
 *    on *any* page): tapping starts/stops the shared call — talk and be
 *    interrupted naturally, hear the AI's voice back, and navigate to other
 *    pages via the ``navigate_to`` tool without the call dropping.
